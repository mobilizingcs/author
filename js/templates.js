(function(global){
	global.templates = {
		"urn" : '<div class="form-group"><label>{{label}}</label><input class="form-control prompt_field" data-field="{{field}}" placeholder="{{placeholder}}" {{required}}></div>',
		"string" : '<div class="form-group"><label>{{label}}</label><input class="form-control prompt_field" data-field="{{field}}" placeholder="{{placeholder}}" value="{{default}}" {{required}}></div>',
		"text" : '<div class="form-group"><label>{{label}}</label><textarea rows="2" class="form-control prompt_field" data-field="{{field}}" placeholder="{{placeholder}}" {{required}}>{{default}}</textarea></div>',
