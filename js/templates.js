(function(global){
	global.templates = {
		...
		"number" : '<div class="form-group"><label class="control-label">{{label}}</label><input type="number" min="0" value="{{default}}" class="form-control prompt_field" data-field="{{field}}" placeholder="{{placeholder}}"></div>',
